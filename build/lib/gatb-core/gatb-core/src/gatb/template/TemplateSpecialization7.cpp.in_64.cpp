...
template class Simplifications <GraphTemplate<Node_t<Kmer<64>::Type>,Edge_t<Node_t<Kmer<64>::Type > >, GraphDataVariantT>, Node_t<Kmer<64>::Type>, Edge_t<Node_t<Kmer<64>::Type > >>; 
